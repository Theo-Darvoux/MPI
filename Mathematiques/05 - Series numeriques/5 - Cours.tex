...
\begin{ex}{Théorème de Cesàro.}{}
    ...
    \end{align*}
    Alors àpdcr, $|v_n-l|\leq\e$, donc $v_n\to l$.
\end{ex}
...
\begin{prop}{Produit de Cauchy de deux séries absolument convergentes.}{}
...
\begin{app*}{}{}
    ...
    \tcblower
    Soient $x,y\in\R$. On a $e^x$ et $e^y$ absolument convergentes, donc leur produit de Cauchy l'est :
    \begin{equation*}
...
\begin{prop}{Critère spécial des séries alternées.}{}
    ...
    Si $|u_n|$ tend vers 0 \bf{en décroissant}, alors $\sum u_n$ converge.\\
