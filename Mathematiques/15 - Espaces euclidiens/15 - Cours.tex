...
\begin{exercice}{}{}
    Soit $E$ euclidien et $u,v\in\S(E)$ tels que $uv=vu$. Montrer que $u$ et $v$ sont orthogonalement codiagonalisables.
    \tcblower
    Soit $\l\in\Sp(u)$. On prend $\B_\l$ une b.o.n. de $E_\l$ de $\vp$ de $v$, qui existe par théorème spectral puisque $v_{|E_\l}\in\Sp(E_\l)$.\\
    On a $E=\bigoplus_{\l\in\Sp(u)}E_\l$ donc $\B=\bigsqcup_{\l\in\Sp(u)}\B_\l$ est une b.o.n. de $\vp$ de $v$ et de $u$.
\end{exercice}
