...
\begin{exercice}{Formule de Cauchy.}{}
    ...
    \end{align*}
    (*) On pose $u_k=a_kr^ke^{i(k-n)\theta}$, on vérifie que $\sum_{k\geq}u_k$ $\CU$ sur $[0,2\pi]$.
    \begin{equation*}
...
\begin{ex}{}{}
    ...
    \end{equation*}
    \begin{equation*}
        \forall x \in ]-1,1[, ~ \sum_{n=0}^\infty nx^{n} = \frac{x}{(1-x)^2}.
    \end{equation*}
    \begin{equation*}
...
\begin{ex}{}{}
    ...
    \end{equation*}
    \tcblower
    Elle est $\cursive{C}^\infty$ comme quotient de fonctions $\cursive{C}^\infty$.
    \begin{equation*}
