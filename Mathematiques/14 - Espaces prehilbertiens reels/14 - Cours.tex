...
\begin{prop}{Cauchy-Schwarz.}{}
    ...
    D'abord $P\in\R_2[X]$ car $P(\l)=\Lg x, x \Rg + 2\l \Lg x, y \Rg + \l^2 \Lg y, y \Rg$ par symétrie.\\
...
\begin{thm}{}{}
    Soit $(E,\Lg\cdot,\cdot\Rg)$ un espace préhilbertien réel.
    \begin{equation*}
        \forall (x, y) \in E^2, ~ \Lg x, y \Rg = 0 \iff \| x + y \|^2 = \| x \|^2 + \| y \|^2
    \end{equation*}
\end{thm}
...
\begin{ex}{}{}
    ...
    D'après Weierstraß, il existe $(P_n)_n$ une suite de polynômes convergeant uniformément vers $f$ sur $[a,b]$. Ainsi :
    \begin{equation*}
        \forall n \in \N, ~ \int_a^b f^2(t)\dt = \int_a^b f(t)\left( f(t) - P_n(t) \right)\dt +  \cancel{\int_a^b f(t)P_n(t)\dt}
    \end{equation*}
    Puis :
    \begin{equation*}
        \forall n \in \N, ~ 0 \leq \int_a^b f^2(t)\dt \leq \|P_n - f\|_{\infty}^{[a,b]} \int_a^b|f(t)|\dt \xrightarrow[n\to+\infty]{}0.
    \end{equation*}
...
\begin{ex}{Exemples de bases orthonormées.}{}
    Les bases canoniques de $\R^n$, et de $\M_n(\R)$.
    \tcblower
...
\begin{exercice}{}{}
    ...
    Avec $P=XA\in\R_n[X]$, on a $P(0)=\int_0^1A(t)P(t)\dt=0$, donc $\int_0^1tA^2(t)\dt=0$, donc $A=0$, absurde.
\end{exercice}
...
\begin{exercice}{}{}
    ...
    \tcblower
    On a $\forall x \in E, ~ \|u^*(x)\|^2=\Lg x, ((u^*)^*\circ u^*)(x)\Rg = \Lg x, (u\circ u^*)(x)\Rg=0_\R$ car $u\circ u^*=0$.\\
...
\begin{exercice}{}{}
    ...
    \end{equation*}
    \begin{equation*}
        \l_1C_1 + ... + \l_nC_n = \begin{pmatrix}\Lg\l_1a_1+...+\l_na_n, a_n\Rg\\\vdots\\\Lg\l_1a_1+...+\l_na_n,a_n\Rg\end{pmatrix}=\begin{pmatrix}0\\\vdots\\0\end{pmatrix}=0_{\R^n}.
    \end{equation*}
...
\begin{prop}{Produit mixte.}{}
    ...
    Le produit mixte de $(x_1,...,x_n)$ noté $[x_1,...,x_n]$ est le scalaire défini par $\det_\B(x_1,...,x_n)$ où $\B$ est une b.o.n. orientée quelconque de $E$. Il ne dépend pas de la base $\B$ choisie.
    \tcblower
    Soient $\B,\B'$ deux b.o.n directes. On sait que $\det_\B=\l\det_{\B'}$ avec $\l=\det_\B\B'$.\\
    Or la matrice de passage $P$ de $\B$ à $\B'$ est orthogonale, donc $\det(P)\in\{-1,1\}$.\\
...
\begin{exercice}{}{}
    ...
    Alors, $\Ker(A-I_p)\oplus\Im(A-I_p)$ puis par théorème du rang, $\R^p=\Ker(A-I_p)\oplus\Im(A-I_p)$.\\
...
\begin{exercice}{}{}
    ...
    \begin{equation*}
        \forall i \in \lb1,n\rb, ~ Q(i) = 1 + \sum_{k=1}^n\l_k\frac{(k+i)!}{i!} = 1+-1=0.
    \end{equation*}
