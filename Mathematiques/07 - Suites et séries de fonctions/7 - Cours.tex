...
\begin{thm}{Approximation de Weierstraß. $\star$}{}
    ...
    \begin{equation*}
        ...
        \end{cases}
    \end{equation*}
    Cette fonction répond au problème.
\end{thm}

\begin{app}{Lemme de Riemann-Lebesgue.}{}
    Soit $f:[a,b]\to\K$ continue par morceaux. Montrer que :
    \begin{equation*}
        \lim_{\l\to+\infty}\int_a^bf(t)e^{i\l t}\dt = 0.
    \end{equation*} 
    \tcblower
...
\begin{ex}{Zeta de Riemann alternée.}{}
    ...
    \begin{align*}
        \sum_{n=1}^{+\infty}(-1)^{n+1}\left( \frac{1}{n^x} - \frac{1}{(n+1)^a} \right) &= \sum_{n=1}^{\infty}\frac{(-1)^{n+1}}{n^x} - \sum_{n=1}^{\infty}\frac{(-1)^{n+1}}{n^{x+1}}.\\
        &=\sum_{n=1}^\infty\frac{(-1)^{n+1}}{n^x} - \sum_{n=2}^{\infty}\frac{(-1)^n}{n^x}\\
        &= \sum_{n=1}^\infty\frac{(-1)^{n+1}}{n^x} + \sum_{n=2}^{\infty}\frac{(-1)^{n+1}}{n^x}\\
        &= 2\sum_{n=1}^{\infty}\frac{(-1)^{n+1}}{n^x} - 1 = 2f(x)-1.
    \end{align*}
...
\begin{thm}{}{}
    Pour $A_n=\sum_{k=0}^na_k$,
    \begin{equation*}
        \sum_{n=0}^{+\infty}A_nx^n = \left( \sum_{n=0}^{+\infty}x^n \right)\left( \sum_{n=0}^{+\infty}a_nx^n \right).
    \end{equation*}
\end{thm}
