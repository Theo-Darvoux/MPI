...
\begin{defi}{}{}
    Soit $E$ un ensemble non-vide. On dit que $E$ est fini ssi $\exists n \in \N$ et $\phi$ une bijection de $\lb 1, n \rb$ sur $E$.\\
...
\begin{exercice}{}{}
    ...
    Alors $\Pr(A_n)=\frac{1}{6}$ et $A=\bigcup_{n\in\N} A_n$, donc $\ov{A}=\bigcap_{n\in\N}\ov{A}$ avec $\Pr(\bigcap_{k=0}^n A_k)=\frac{1}{6^n}$ d'où $\Pr(\bigcap_{k=0}^n\ov{A_k})=\left( \frac{5}{6} \right)^n$.\\
